"""Build the strategy-level AstraKV ON/OFF TTFT validation report."""
...
from astrakv.benchmarks.policy_ab_ttft import build_suite_report, write_suite_report
...
def main() -> int:
    ...
    print(f"Event timeline written to {written['timeline']}")
    print(f"Revisit samples written to {written['samples']}")
    return 0
